...
![aby_share-overhead](ABYFig/aby_share_overhead.png)


三种最重要的计算理论开销如下：

![aby_mul_cmp_mux_overhead](ABYFig/aby_mul_cmp_mux_overhead.png)
...
![MULT VIEW](ABYFig/mult_overview.png)
...
![MULT ABY2.0](ABYFig/aby2_mult.png)
...
![MULT OVERHEAD](ABYFig/aby2_mult_overhead.png)
...
![SHARE OVERHEAD](ABYFig/aby2_share_conversion.png)


  **Special Conversions:** ABY2.0基于Bit2A做了三种比较高效转化如下（PQ, PV, PQV），比较直观不做过多介绍。

![PQ, PV, PQV](ABYFig/aby2_pq_pv_pqv.png)
...
![img](ABYFig/ppml1.png)

![img](ABYFig/ppml2.png)

![img](ABYFig/ppml3.png)

![img](ABYFig/ppml4.png)
